...
\lstinputlisting[style=Ocaml, caption=Début du code source d'automateEnDurReels.ml, firstline=10, lastline=108]{../../../codes/Ex2/automateEnDurReels.ml}


%% ---- 4)
\subsubsection{Implantation de l'automate complet}
\lstinputlisting[style=Ocaml, caption=Le reste du code source d'automateEnDurReels.ml, firstline=111]{../../../codes/Ex2/automateEnDurReels.ml}
